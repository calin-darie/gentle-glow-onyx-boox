...
public class BrightnessAndWarmthToWarmAndColdLedOutputAdapter {
    ...
    public WarmColdSetting toWarmCold (BrightnessAndWarmth brightnessAndWarmth) {
        ...
        return new WarmColdSetting(warmLedOutput, coldLedOutput);
    }

    public BrightnessAndWarmth findBrightnessAndColdApproximationForWarmCold(WarmColdSetting warmCold) {
